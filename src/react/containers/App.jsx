...
import CreateRateContainer from './CreateRateContainer'
import CustomRateContainer from './CustomRateContainer'
    ...
    return (
        <>
            ...
            <Switch>
                ...
                <Route path="/create" exact component={CreateRateContainer}/>
                <Route path="/custom-rate" exact component={CustomRateContainer}/>
